...
![Blog workspace preview](../../assets/blog-placeholder-about.jpg)

Here is an inline `const title = "First post"` example inside a paragraph.
...
function getPostTitle(entry) {
  return entry.published ? entry.title : "Draft";
}
